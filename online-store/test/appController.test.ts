...
import { mockOptions,  mockDataState,  mockData, mockonChange,  mockFilterData,  mockLoad } from './__mocks__/appController'
...
describe('AppController', () => {
  ...
  describe('onResetAll', () => {
    it('should delete filters, sorter, cart from datastate', () => {
      ...
      expect(mockState.dataState).toEqual({ sorter: {}, filter: {}, cart: {} })
    })
  })
  ...
  describe('getParamInputRange', () => {
    it('should change min, max in paramInputRange', () => {
      const newParameters = [
            { filter: "Price", id: "price", step: "1", min: "500", max: "1300", value: { left: "min", right: "max" } },
          ]
    ...
    it('should change value in paramInputRange when it has in dataState.filter', () => {
      ...
      const newParameters = [
            { filter: "Price", id: "price", step: "1", min: "500", max: "1300", value: { left: "600", right: "1000" } },
          ]
      const result = controller.getParamInputRange()
      expect(result).toEqual(newParameters)
    })
